...
func counts(global, session int) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</h1><p class=\"subtitle has-text-centered\">Level</p><div><label for=\"level\">Level</label><br><input type=\"text\" id=\"level\" name=\"level\"></div><div><button class=\"button is-secondary\" type=\"submit\" name=\"session\" value=\"session\">Calculate</button></div></div></div></form>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return templ_7745c5c3_Err
